...
(function (win, doc, $) {
	...
	// Our enclosing function was using the global scope on line 78, so passing these params to make it more controlled


	// Creating a public api inside the window object
	// if statement is so that we create the API only once
